              ...
              {pendingMembers.map((member) => (
                <div key={member.userId} className="flex items-center justify-between p-3 hover:bg-muted/30 rounded-xl transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    />
                    <div>
                      <p className="text-sm font-bold text-foreground wrap-break-word break-all">{member.displayName || member.username}</p>
  ...
  return (
    <div className="flex items-center justify-between p-3 hover:bg-muted/30 rounded-xl transition-colors group">
      <div className="flex items-center gap-3">
        ...
        />
        <div>
          <p className="text-sm font-bold text-foreground wrap-break-word break-all flex items-center gap-1.5">
            ...
            {posts.map((post: Post) => (
              <div key={post.id} className="bg-card p-5 rounded-2xl border border-border shadow-sm">
                <div className="flex items-center gap-3 mb-3">
                  ...
                  />
                  <div>
                    <p className="text-sm font-bold text-foreground wrap-break-word break-all">{post.author?.displayName || "Người dùng"}</p>
                  </div>
                </div>
                <p className="text-foreground wrap-break-word break-all text-[15px] mb-5">{post.content}</p>
                <div className="flex gap-2">
